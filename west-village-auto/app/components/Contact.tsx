...
const HOURS = [
  { day: "Monday – Tuesday", time: "8:00 AM – 6:00 PM" },
  { day: "Wednesday – Thursday", time: "8:00 AM – 4:00 PM" },
  { day: "Friday – Saturday", time: "8:00 AM – 6:00 PM" },
    ...
    <section id="contact" className="bg-bg-card/30 py-20">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-5 sm:px-8 lg:grid-cols-2">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary">
                  743 Greenwich St, New York, NY 10014
                </p>
              </div>
            </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-border">
          <iframe
            title="West Village Auto Repair location"
            src="https://www.google.com/maps?q=743+Greenwich+St,+New+York,+NY+10014&output=embed"
            width="100%"
            height="100%"
