...
const HOURS = [{ day: "Every day", time: "Open 24 hours" }];
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-5 sm:px-8 lg:grid-cols-2">
        <div>
          ...
          <h2 className="mb-6 text-3xl font-bold text-text-primary sm:text-4xl">
            Stop by, call, or ask us to come to you
          </h2>
          ...
          >
            <Phone size={16} />
            Call now — we&rsquo;re open
          </a>
        </div>

        <div className="overflow-hidden rounded-2xl border border-border">
          <iframe
            title="Cali's Auto Repair & Diagnostics location"
            src="https://www.google.com/maps?q=541+E+149th+St,+Bronx,+NY+10455&output=embed"
            width="100%"
            height="100%"
