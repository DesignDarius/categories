...
const ITEMS = [
  { icon: Star, label: "4.6★ · 71 reviews", sub: "Google Business" },
  { icon: CalendarClock, label: "10+ years", sub: "Finsbury Park" },
  { icon: ShieldCheck, label: "MOT Testing Station", sub: "On-site testing" },
  { icon: Award, label: "BMW Specialist", sub: "All makes welcome" },
];
