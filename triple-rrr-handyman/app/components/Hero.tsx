  ...
  return (
    <section id="top" className="relative overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/hero-decking.jpg"
          alt="A finished timber deck built by Triple RRR Handyman Services"
          fill
          priority
      ...
      {/* Glow orbs — subtler than the phone-repair site, more restrained/trustworthy */}
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-start px-5 pb-16 pt-20 sm:px-8 sm:pb-24 sm:pt-28">
        <Reveal>
          <div className="mb-4 flex items-center gap-2 rounded-full border border-border bg-bg-card/70 px-4 py-1.5 text-xs font-medium text-text-secondary backdrop-blur">
            ...
            5.0 rating · Carnegie, Melbourne
          </div>
        </Reveal>

        <Reveal delay={100}>
          <h1 className="max-w-2xl text-4xl font-extrabold leading-tight tracking-tight text-text-primary sm:text-6xl">
            From new decking to century-old lamps.
          </h1>
        </Reveal>

        <Reveal delay={200}>
          <p className="mt-5 max-w-xl text-base text-text-secondary sm:text-lg">
            Outdoor builds, repairs, installations and the odd bit of
            restoration work — one reliable handyman for the jobs other
            people won&rsquo;t take on.
          </p>
        </Reveal>
        ...
        <Reveal delay={300}>
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <a
              href="https://www.google.com/maps/place/Triple+RRR+Handyman+Services/data=!4m7!3m6!1s0x6ad66b239baa3483:0xa0e2efbfb8d370fc!8m2!3d-37.8861695!4d145.065949!16s%2Fg%2F11lkvnx0s6!19sChIJgzSqmyNr1moR_HDTuL_v4qA?authuser=0&hl=en"
              target="_blank"
