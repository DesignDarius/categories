import { Hammer, MapPin, Sparkles, Star } from "lucide-react";
import Reveal from "./Reveal";

const ITEMS = [
  { icon: Star, label: "5.0★ Google", sub: "Rated by real customers" },
  { icon: Hammer, label: "Outdoor & indoor", sub: "Decking to repairs" },
  { icon: Sparkles, label: "Restoration too", sub: "Furniture, lamps & more" },
  { icon: MapPin, label: "Carnegie based", sub: "Melbourne wide" },
];
