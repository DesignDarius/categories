...
const PHOTOS = [
  {
    src: "/images/collision-repair.jpg",
    alt: "Collision panel repair on a BMW M3 at G Auto Repair & Service",
    caption: "Crash & panel repair, not just servicing",
  },
  {
    src: "/images/engine-rebuild.jpg",
    alt: "Engine cylinder head and camshafts during a rebuild",
    caption: "Engine work, down to the last valve",
  },
];
